    ...
    <div class="card bg-dark">
        <div class="row bg-secondary text-white">
            <article class="card-body p-5">    
                <div class=""><label class="labels"><b>Nama Produk</b> </label><input type="text" class="form-control" placeholder="Nama Produk" value=""></div>
                <div class=""><label class="labels"><b>Harga </b> </label><input type="text" class="form-control" placeholder="Harga Produk" value=""></div>
